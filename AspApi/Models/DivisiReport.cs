...
namespace AspApi.Models
{
    public class DivisiReport
    {
        ...
        List<DivisiVM> _division = new List<DivisiVM>();
        #endregion

        public byte[] PrepareReport(List<DivisiVM> divisions)
        {
            _division = divisions;
        ...
        private void ReportBody()
        {
            ...
            int serialNumber = 1;
            foreach (DivisiVM divisi in _division)
            {
                ...
                _pdfPCell = new PdfPCell(new Phrase(divisi.Nama, _fontStyle));
                _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                _pdfPCell.BackgroundColor = BaseColor.WHITE;
                _pdfTable.AddCell(_pdfPCell);
